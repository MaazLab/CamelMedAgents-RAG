...
# - Red flag true ONLY if the patient query suggests a potentially life-threatening or emergency condition that requires urgent medical attention.
...
SYSTEM_PROMPT = """ You are a clinical medical information extraction engine.
